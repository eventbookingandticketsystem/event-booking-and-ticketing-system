...
// Gradient "posters" — clean placeholders, not fake photography.
const POSTERS = {
...
const SSP = (n) => "SSP " + n.toLocaleString("en-US");
...
const DASH = {
  ...
  admitted: 1247, capacity: 2000,
  sold: 1891, fraud: 4, revenue: 94550,
  // entry rate per 30-min interval
  entryRate: [
    { t: "17:00", v: 40 }, { t: "17:30", v: 120 }, { t: "18:00", v: 286 },
    { t: "18:30", v: 341 }, { t: "19:00", v: 220 }, { t: "19:30", v: 130 },
    { t: "20:00", v: 74 }, { t: "20:30", v: 36 },
  ],
  tiers: [
    { name: "VIP", count: 388, total: 1247, color: "var(--accent)" },
    { name: "General", count: 712, total: 1247, color: "var(--navy)" },
    { name: "Student", count: 147, total: 1247, color: "var(--info)" },
  ],
  scans: [
...
const ATTENDEE_NAMES = ["Achol Deng", "Manute Bol Jr.", "Nyandeng Garang", "Peter Lado", "Aban Wani", "Sunday Akol"];
...
// Reports: post-event (completed graduation)
const REPORT = {
  event: "University of Juba Graduation 2025",
  attended: 1043, revenue: 5215000, fraud: 7, duration: "1h 52m",
  entryRate: [
    { t: "07:30", v: 60 }, { t: "08:00", v: 410 }, { t: "08:30", v: 520 },
    { t: "09:00", v: 180 }, { t: "09:30", v: 40 }, { t: "10:00", v: 12 },
  ],
  tiers: [{ name: "Family", count: 1043, total: 1043, color: "var(--accent)" }],
  fraudRows: [
...
Object.assign(window, { POSTERS, SSP, EVENTS, EVENT_BY_ID, MY_TICKETS, DASH, ATTENDEE_NAMES, ORG_EVENTS, GATE_AGENTS, REPORT });

// ============================================================
// ADMIN mock data (system-wide)
// ============================================================
const ADMIN_OVERVIEW = {
  organizers: 24, activeToday: 3, ticketsAllTime: 14820, fraud30d: 47,
  // tickets sold per day, last ~14 points (label = date)
  salesTrend: [
    { t: "22 Nov", v: 210 }, { t: "24", v: 340 }, { t: "26", v: 290 }, { t: "28", v: 520 },
    { t: "30", v: 610 }, { t: "2 Dec", v: 880 }, { t: "4", v: 1240 }, { t: "6", v: 1610 },
  ],
  activity: [
...
const ORGANIZER_BY_ID = Object.fromEntries(ORGANIZERS.map((o) => [o.id, o]));
...
// All events for admin oversight (extends ORG_EVENTS with organizer + fraud)
const ALL_EVENTS = [
...
// Gate agents (admin oversight view) — extends GATE_AGENTS with activity
const ADMIN_AGENTS = [
...
const SYSTEM_HEALTH = {
  uptime: "99.7%", responseTime: "1.4s", failedCallbacks: 2,
  services: [
...
Object.assign(window, { ADMIN_OVERVIEW, ORGANIZERS, ORGANIZER_BY_ID, ORG_ACTIVITY, ALL_EVENTS, ADMIN_AGENTS, AGENT_SCAN_HISTORY, SYSTEM_HEALTH });

// ============================================================
// EXPLORE — public discovery page data (rich gradient posters)
// ============================================================
const EXPLORE_POSTERS = {
...
// status → pill descriptor; non-active events show their date label
const EXPLORE_EVENTS = [
  { id: "x-jmf", title: "Juba Music Festival 2025", category: "Music", venue: "Juba Stadium", city: "Juba",
    ...
    tiers: [ { id: "vip", name: "VIP", price: 2500, remaining: 40 }, { id: "gen", name: "General", price: 500, remaining: 1200 } ] },
  { id: "x-psl", title: "South Sudan Premier League Final", category: "Sports", venue: "Juba Stadium", city: "Juba",
    ...
    tiers: [ { id: "vip", name: "VIP Stand", price: 800, remaining: 60 }, { id: "gen", name: "General Stand", price: 200, remaining: 3400 } ] },
  ...
  { id: "x-biz", title: "Juba International Business Conference", category: "Conference", venue: "Radisson Juba", city: "Juba",
    ...
    tiers: [ { id: "del", name: "Delegate", price: 1500, remaining: 120 }, { id: "vip", name: "Executive", price: 4000, remaining: 30 } ] },
  { id: "x-jazz", title: "Juba Jazz Evening", category: "Music", venue: "Eden Garden Juba", city: "Juba",
    ...
    tiers: [ { id: "gen", name: "General", price: 300, remaining: 400 }, { id: "vip", name: "Lounge", price: 1200, remaining: 50 } ] },
...
const EXPLORE_BY_ID = Object.fromEntries(EXPLORE_EVENTS.map((e) => [e.id, e]));

const EXPLORE_CATEGORIES = ["All", "Music", "Sports", "Conference", "Graduation", "Church", "Food & Drinks", "Arts & Culture"];
const EXPLORE_TIMES = [
...
const EXPLORE_CITIES = ["Juba", "Wau", "Malakal", "Yei", "All Cities"];

Object.assign(window, { EXPLORE_POSTERS, EXPLORE_EVENTS, EXPLORE_BY_ID, EXPLORE_CATEGORIES, EXPLORE_TIMES, EXPLORE_CITIES });

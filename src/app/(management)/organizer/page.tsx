        ...
        {!isLoading && !isError && !d && (
          <>
            ...
            <div className="bg-surface border border-border rounded-lg p-6">
              <EmptyState
                icon="CalendarOff"
                heading="No live event"
                subtext="Publish an event to start seeing real-time attendance data here."
              />
            </div>
          </>
        )}
          ...
          <>
            ...
            <div className="bg-surface border border-border rounded-lg p-5">
              ...
              {lineData.length > 0 ? (
                ...
                <div className="h-50 flex items-center justify-center text-sm text-text-muted">
                  No scan data yet
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              <div className="bg-surface border border-border rounded-lg p-5">
                ...
                {barData.length > 0 ? (
                  ...
                  <div className="h-30 flex items-center justify-center text-sm text-text-muted">
                    No tier data
                  </div>
                )}
              </div>
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between px-4 py-3 border-t border-border bg-surface-bg">
                      <span className="text-xs text-text-muted">
                        Showing {d.scans.length} recent scans
                      </span>

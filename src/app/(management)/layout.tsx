...
function MobileBottomNav({
  ...
  return (
    <nav
      className="grid border-t border-border bg-surface shrink-0 px-1 py-1.5 pb-[calc(6px+env(safe-area-inset-bottom))]"
    ...
    <>
      ...
      <div className="flex lg:hidden flex-col min-h-screen bg-surface-bg">
        ...
        <div className="fixed bottom-0 left-0 right-0 z-30">
          <MobileBottomNav active={activeNav} onNav={handleNav} />
        </div>
      </div>
